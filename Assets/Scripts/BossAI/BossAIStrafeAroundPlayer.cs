...
public class BossAIStrafeAroundPlayer : StateMachineBehaviour
{
	...
	public override void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
	{
		...
		_helper.BossCharacter.MoveXZ(-0.75F * _helper.BossCharacter.transform.right, targetSystemEngaged: true, _helper.PlayerCharacter);
