...
public class ConsumableSpawner : MonoBehaviour
{
    ...
    private Vector3 CreateSpawnLocation()
    {
        ...
        Vector3 _spawnLocation = new Vector3(transform.position.x + Random.Range(-TriggerSize.x, TriggerSize.x), 
            transform.position.y, transform.position.z + Random.Range(-TriggerSize.z, TriggerSize.z));
